...
<html lang="en">
  ...
  <body>
            ...
            <div class="container p-1" >
				<div class="row">
					...
					<div class="col nav justify-content-end">
						<div class="login my-2" onclick="login()" style="cursor : pointer"> <i class="fa fa-user text-white ">&nbsp&nbsp Sign in</i></div>
					</div>
				</div>
            </div>
        </div>
	...
	<div class="mx-5 my-4">
		<h6 class="text-secondary">Keels.lk > Product List ></h6>
							...
							echo ' <div class="col">
									<div class="card">
									  ...
									  <div class="card-body">
										...
										<div class="row">
											<div class="col text-success"><i class="fas fa-hand-holding-usd"></i>
											'; echo $row["price"]; echo '
											</div>
											<div class="col text-warning"><i class="fas fa-cubes"></i>
												'; echo $row["Qty"]; echo '
											</div>
										</div>
									  </div>
		...
		.
		<div class="my-4">
			<h6 class="text-secondary">Keels.lk > Graphs ></h6>
			<div class="row mx-2 my-4">
			  <div class="col-sm-6">
				<div class="">
				  <div class="card-body">
					<div id="percentagechart" class="">
